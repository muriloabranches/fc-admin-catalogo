...
import dev.muriloabranches.admin.catalogo.MySQLGatewayTest;
...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAValidCategory_whenCallsUpdate_shouldReturnCategoryUpdated() {
        ...
        final var aCategory = Category.newCategory("Movi", null, expectedIsActive);
        ...
        Assertions.assertEquals("Movi", actualInvalidEntity.getName());
    ...
    public void givenPrePersistedCategories_whenCallsFindAll_shouldReturnPaginated() {
        ...
        final var tvShows = Category.newCategory("TV Shows", null, true);
        ...
        categoryRepository.saveAll(List.of(
                ...
                CategoryJpaEntity.from(tvShows),
    ...
    public void givenFollowPagination_whenCallsFindAllWithPage1_shouldReturnPaginated() {
        ...
        Assertions.assertEquals(expectedTotal, actualResult.total());
        Assertions.assertEquals(expectedPerPage, actualResult.items().size());
        Assertions.assertEquals(tvShows.getId(), actualResult.items().get(0).getId());
    }
    ...
    public void givenPrePersistedCategoriesAndMostWatchedAsTerms_whenCallsFindAllAndTermsMatchesCategoryDescription_shouldReturnPaginated() {
        ...
        final var tvShows = Category.newCategory("TV Shows", "One watched category", true);
...
//        Assertions.assertEquals(3, categoryRepository.count());
//
//        final var expectedIds = List.of(movies.getId(), tvShows.getId());
//
//        final var ids = List.of(movies.getId(), tvShows.getId(), CategoryID.from("123"));
//
